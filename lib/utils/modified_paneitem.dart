...
class ThemablePaneItem extends PaneItem {
  ...
  static Color uncheckedInputAlphaColor(
  ...
  Widget build(
    ...
    final PaneDisplayMode mode = forceDisplayMode ??
        displayMode ??
      ...
      child: HoverButton(
        ...
        builder: (context, states) {
          ...
          final textResult = titleText.isNotEmpty
              ? Padding(
                  padding: theme.labelPadding?.flipped ?? EdgeInsets.zero,
